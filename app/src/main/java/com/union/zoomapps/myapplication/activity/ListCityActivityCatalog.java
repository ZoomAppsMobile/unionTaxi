...
public class ListCityActivityCatalog extends MvpAppCompatActivity implements GetCityView {
        ...
        recycler_list_city.addOnItemTouchListener(
                new RecyclerItemClickListener(this, recycler_list_city, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        intent = new Intent(ListCityActivityCatalog.this, CatalogActivity.class);
